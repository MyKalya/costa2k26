...
export const ROOMS = [
  ...
  },
  {
    ...
    bed: "Two Queens",
    bath: "Ensuite",
    occupants: ["Supena", "Januka", "BallerSai"],
    note: "Balcony",
    status: "Assigned",
  },
  {
  ...
  },
  {
    ...
    bed: "Two Queens",
    bath: "Ensuite",
    occupants: ["Andrew", "Raja", "Netharrshan"],
    note: "Balcony",
    status: "Assigned",
  },
] as const;
...
export const FLOORS = {
  ...
  "15": {
    ...
    "Main House 1st Floor": ["V15-3"],
    "Main House 2nd Floor": ["V15-4", "V15-5", "V15-6"],
  },
  "16": {
    "Detached Suites": ["V16-11 Master", "V16-12 Master"],
...
export const ROOM_DETAILS: Record<string, { ensuite: boolean; capacity: number; amenities?: string[] }> = {
  ...
  "V16-12 Master": { ensuite: true, capacity: 2, amenities: ["Balcony", "Detached suite"] },
