...
const days: DayCardProps[] = [
  ...
  },
  {
    ...
    vibeSummary: "Choose your own adventure. Explore town, do an activity, come ATV'ing with us, options are endless. Nothing is mandatory. Go with whatever pace feels right. But let's do dinner together, hosted by Private Chef Antonio",
    notes: [
